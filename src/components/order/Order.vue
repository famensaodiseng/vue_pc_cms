 ...
 * @version: list
 * @Author: yang_ft
 * @Date: 2020-01-12 11:56:57
 * @github: famensaodiseng
 * @LastEditTime : 2020-01-12 16:02:20
 -->
<template>
  <div>
    <!-- 面包屑导航 -->
    ...
    <el-card>
      ...
      <el-table :data="orderlist" border stripe>
        <el-table-column type="index">序列</el-table-column>
        <el-table-column label="订单编号" prop="order_number"></el-table-column>
        <el-table-column label="订单编号" prop="order_price"></el-table-column>
        <el-table-column label="订单价格" prop="order_number"></el-table-column>
        ...
        <el-table-column label="操作">
          <el-table-column>
            ...
            <template>
              <el-button @click="showBox" type="primary" icon="el-icon-edit" size="mini" circle></el-button>
              <el-button
...
export default {
  data() {
    return {
      ...
      addressFormRules: {
        address1: [{ required: true, message: '请选择省市区县', tigger: 'blur' }],
        address2: [{ required: true, message: '请选择详细地址', tigger: 'blur' }]
      },
      cityData: cityData,
