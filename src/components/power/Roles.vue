 ...
 * @version: Roles
 * @Author: yang_ft
 * @Date: 2020-01-04 11:00:52
 * @github: famensaodiseng
 * @LastEditTime : 2020-01-04 16:30:58
 -->
  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="rolelist" border stripe width="300px">
        <el-table-column type="expand" label="是否折叠" width="100px">
        ...
        <el-table-column prop="roleDesc" label="角色描述" width="200px"></el-table-column>
        <el-table-column>
          <template slot-scope="scope">
